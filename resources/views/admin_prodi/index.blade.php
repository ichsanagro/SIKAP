...
<div class="max-w-7xl mx-auto p-6">
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-gray-900">Admin Prodi Dashboard</h1>
        <p class="text-gray-600 mt-2">Kelola verifikasi dan penugasan KP mahasiswa</p>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div class="bg-white rounded-lg shadow p-6">
            <h2 class="text-xl font-semibold mb-4">Verifikasi & Penugasan</h2>
            <div class="space-y-3">
                <a href="{{ route('admin-prodi.verifications.index') }}" class="flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                    <div class="flex items-center">
                        <svg class="w-5 h-5 text-green-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                        <span>Verifikasi Pengajuan ({{ $stats['pending_verifications'] }})</span>
                    </div>
                ...
                <a href="{{ route('admin-prodi.assignments') }}" class="flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                    <div class="flex items-center">
                        ...
                        <span>Penugasan Supervisor</span>
                    </div>
                    <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                    </svg>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <h2 class="text-xl font-semibold mb-4">Data & Statistik</h2>
            <div class="space-y-3">
                <a href="{{ route('admin-prodi.companies.index') }}" class="flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                    <div class="flex items-center">
                        ...
                        <span>Perusahaan Mitra ({{ $stats['companies'] }})</span>
                    </div>
                    <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                    </svg>
                ...
                <div class="p-3 bg-gray-50 rounded-lg">
                    <div class="flex items-center">
                        ...
                        <div>
                            <span class="block font-medium">Supervisor Ditugaskan</span>
                            <span class="text-sm text-gray-600">{{ $stats['assigned_supervisors'] }} mahasiswa</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-3 bg-gray-50 rounded-lg">
                    <div class="flex items-center">
                        ...
                        <div>
                            <span class="block font-medium">Pengawas Lapangan Ditugaskan</span>
                            <span class="text-sm text-gray-600">{{ $stats['assigned_field_supervisors'] }} mahasiswa</span>
                        </div>
                    </div>
                </div>
            </div>
