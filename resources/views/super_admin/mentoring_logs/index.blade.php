...
<div class="max-w-7xl mx-auto p-6">
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Manajemen Log Bimbingan</h1>
            <p class="text-gray-600 mt-2">Kelola semua log bimbingan</p>
        </div>
    ...
    <div class="bg-white shadow rounded-lg overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <h2 class="text-lg font-semibold">Semua Log Bimbingan ({{ $logs->total() }})</h2>
        </div>
            ...
            <table class="w-full">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="text-left p-4">Topik</th>
                    ...
                    <tr class="border-t hover:bg-gray-50">
                        ...
                        <td class="p-4">
                            <span class="px-2 py-1 rounded-full text-xs font-medium
                                ...
                                @if($log->status === 'APPROVED') DISETUJUI
                                @elseif($log->status === 'REVISED') DIREVISI
                                @else MENUNGGU @endif
                            </span>
                        </td>
                ...
                @empty
                    <tr>
                        <td colspan="7" class="p-8 text-center text-gray-500">Tidak ada log bimbingan ditemukan.</td>
                    </tr>
                @endforelse
                </tbody>
            </table>
