...
<div class="max-w-7xl mx-auto p-6">
    ...
    <div class="bg-white shadow rounded-lg overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <h2 class="text-lg font-semibold">All Applications ({{ $applications->total() }})</h2>
        </div>
            ...
            <table class="w-full">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="text-left p-4">Field Supervisor</th>
                ...
                @empty
                    <tr>
                        <td colspan="8" class="p-8 text-center text-gray-500">No applications found.</td>
                    </tr>
                @endforelse
                </tbody>
            </table>
