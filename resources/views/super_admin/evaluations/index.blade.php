...
<div class="max-w-7xl mx-auto p-6">
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Manajemen Evaluasi Lapangan</h1>
    ...
    <div class="bg-white shadow rounded-lg overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <h2 class="text-lg font-semibold">Semua Evaluasi Lapangan ({{ $evaluations->total() }})</h2>
        </div>
            ...
            <table class="w-full">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="text-left p-4">Evaluasi</th>
                        <th class="text-left p-4">Umpan Balik</th>
                ...
                @empty
                    <tr>
                        <td colspan="7" class="p-8 text-center text-gray-500">Tidak ada evaluasi ditemukan.</td>
                    </tr>
                @endforelse
                </tbody>
            </table>
