                            ...
                            <div class="ml-4">
                                @if($questionnaire->responses->isNotEmpty())
                                    <div class="text-center">
                                        ...
                                        <a href="{{ route('field.questionnaires.show', $questionnaire) }}" class="mt-2 inline-block text-sm text-blue-600 hover:text-blue-800">
                                            Lihat Jawaban
                                        </a>
                                    </div>
                                @else
                                    <a href="{{ route('field.questionnaires.show', $questionnaire) }}" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 focus:bg-blue-700 active:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                        Isi Kuesioner
                                    </a>
                                @endif
                            </div>
